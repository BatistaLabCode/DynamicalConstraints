function dJ = standard_grad(M, P, obj_params)
% Gradient function
%
% Inputs
...
part1 = w_mid * (mu_AB - mu_BA);                % Maximize distance between centers of midpoints
part2 = - w_var * (2*sig_AB + 2*sig_BA) * p1;   % Minimize variance of projection @ midpoint of trajectory
part3 = w_start * (mu_A - mu_B);                  % Maximize distance between starting points of trajectories
